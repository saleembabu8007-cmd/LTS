      ...
      <div className="space-y-1.5 w-full">
        ...
        <div className="relative">
          <select
            ...
            required={required}
            disabled={disabled}
            className={`w-full typography-body-sm rounded-[2px] border transition-colors py-2.5 pl-3 pr-10 bg-white text-[#0B1320] appearance-none cursor-pointer shadow-none focus:outline-none disabled:bg-slate-50 disabled:cursor-not-allowed ${
              error
