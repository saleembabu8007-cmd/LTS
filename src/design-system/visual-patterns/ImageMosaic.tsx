  ...
  return (
    <div className={`grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-stretch ${className}`}>
      ...
      <div className={`lg:col-span-7 flex flex-col ${isReversed ? 'lg:order-2' : 'lg:order-1'}`}>
        <div className="group relative overflow-hidden rounded-[8px] bg-[#173C62] aspect-[4/3] sm:aspect-[16/11] lg:aspect-auto lg:h-full min-h-[360px] sm:min-h-[460px]">
          <img
      ...
      <div className={`lg:col-span-5 flex flex-col gap-6 sm:gap-8 ${isReversed ? 'lg:order-1' : 'lg:order-2'}`}>
        ...
        {/* Supporting Image 01 */}
        <div className="group relative overflow-hidden rounded-[8px] bg-[#173C62] aspect-[16/10] sm:aspect-[16/9] lg:aspect-auto lg:flex-1 min-h-[220px]">
          <img
